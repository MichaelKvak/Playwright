...
test.describe("Sign Up Check Test", () => {
  ...
  test("Should check Sign Up with wrong length Name field", async ({
    page,
  }) => {
  ...
  test("Should check Sign Up with wrong length of Last Name field", async ({
    page,
  }) => {
    await signUpForm.enterName(data.name);
  ...
  test("Should check Sign Up with empty Re-enter password field", async ({
    page,
  }) => {
    await signUpForm.enterName(data.name);
    await signUpForm.enterLastName(data.lastName);
  ...
  test("Should check Sign Up with invalid Re-enter password field", async ({
    page,
  }) => {
    await signUpForm.enterName(data.name);
    await signUpForm.enterLastName(data.lastName);
  ...
  test("Should check Sign Up not match Re-enter password field", async ({
    page,
  }) => {
    await signUpForm.enterName(data.name);
    await signUpForm.enterLastName(data.lastName);
    ...
    await signUpForm.triggerField(signUpForm.passwordField);
    await expect(
      page.getByText(SIGNUP_DO_NOT_MATCH_REENTER_PASSWORD)
